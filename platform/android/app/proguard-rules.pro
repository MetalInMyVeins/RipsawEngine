...
-keep,includedescriptorclasses,allowoptimization class com.ripsawengine.sandbox3d.SDLActivity {
...
-keep,includedescriptorclasses,allowoptimization class com.ripsawengine.sandbox3d.HIDDeviceManager {
...
-keep,includedescriptorclasses,allowoptimization class com.ripsawengine.sandbox3d.SDLAudioManager {
    void registerAudioDeviceCallback();
    void unregisterAudioDeviceCallback();
    void audioSetThreadPriority(boolean, int);
}

-keep,includedescriptorclasses,allowoptimization class com.ripsawengine.sandbox3d.SDLControllerManager {
